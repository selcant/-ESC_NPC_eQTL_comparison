...
expr.esc_rna_vst <- DESeq2::vst(object = t(round(expr.esc_rna)))
expr.npc_rna_vst <- DESeq2::vst(object = t(round(expr.npc_rna)))

expr.esc_rna <- t(expr.esc_rna_vst)
expr.npc_rna <- t(expr.npc_rna_vst)
```
...
ggscatter(var.npc_rna,
  ...
  stat_cor(method = "pearson", label.x = .6, label.y = 1.1) + # Add correlation coefficient
  xlab("Mean") +
  ylab("Variance") +
  theme_pubclean(base_size = 14) +
