...
-   Cell cycle. More specifically the "Mitotic Metaphase and Anaphase", the spindle assembly checkpoint and related processes.
...
gsva_qtl_highlight_npc <- gsva_qtl_npc_peaks %>% 
  filter(
    (chr == 1 & between(interp_bp_peak, 104e06, 113e06)) |
    (chr == 10 & between(interp_bp_peak, 33e06, 40e06) ) |
    (chr == 11 & between(interp_bp_peak, 107e06, 111e06) )
